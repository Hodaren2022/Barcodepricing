                ...
                {scanError ? (
                    ...
                    <div className="relative w-full aspect-video bg-black rounded-lg overflow-hidden mb-4 border-4 border-dashed border-green-400">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                            <div className="w-3/5 h-1/2 border-4 border-green-500 border-opacity-75 rounded-lg"></div>
                        </div>
                    </div>
                )}
    ...
    const saveAndComparePrice = useCallback(async () => {
        ...
        try {
            ...
            if (records.length <= 1) { 
                ...
                const isTrulyBest = (priceRecord.price < bestDeal.price) || (priceRecord.price === bestDeal.price && priceRecord.discountDetails !== '');
